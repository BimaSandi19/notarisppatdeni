    ...
    <div class="row d-flex">
        <div class="col-lg-6 col-sm-12 mb-4">
            ...
            <div class="d-flex align-items-center gap-2 mt-4">
                <span class="iconify" data-icon="mdi:shield-check" data-inline="true" style="font-size: 32px"></span>
                        ...
                        <div class="card-body">
                            <div class="accordion accordion-flush" id="layananAccordion">
                                <div class="accordion-item">
                                    ...
                                    <div id="acc1" class="accordion-collapse collapse" aria-labelledby="acc1Head"
                        ...
                        <div class="card-body">
                            <div class="accordion accordion-flush" id="layananAccordion2">
                                <div class="accordion-item">
                                    ...
                                    <div id="acc2" class="accordion-collapse collapse" aria-labelledby="acc2Head"
                                        data-bs-parent="#layananAccordion2">
                                        <div class="accordion-body" style="text-align: center">
            ...
            <div class="d-flex col-lg-6 col-md-6 col-sm-12 ">
                <div class="container mt-3 py-5" style="color: #ffffff;">
                    ...
                    <div class="icon-with-text mb-3">
                        <span class="iconify large-icon" style="color: #ffffff" data-icon="hugeicons:maps-location-01"
                    ...
                    <div class="icon-with-text mb-3">
                        <span class="iconify large-icon" style="color: #ffffff" data-icon="mdi:email-fast-outline"
                            data-inline="true"></span>
                ...
                <div class="form-container mt-4 mb-4 py-4 w-100">
                    <form action="{{ route('send-proses') }}#form-container" method="POST">
                        ...
                        <div class="mb-2 px-4">
                            ...
                            <input type="text" name="name" class="form-control colored-input" id="name" required />
                        </div>
                        <div class="mb-2 px-4">
                            <label for="email" class="form-label">Email address</label>
                            <input type="email" name="email" class="form-control colored-input" id="email" required />
                        </div>
                        <div class="mb-2 px-4">
                            <label for="subject" class="form-label">Subject</label>
                            <input type="text" name="subject" class="form-control colored-input" id="subject"
                                required />
                        </div>
                        <div class="mb-3 px-4">
                            <label for="message" class="form-label">Message</label>
                            <textarea class="form-control colored-input" name="message" id="message" rows="3"
                                required></textarea>
                        </div>
...
<div class="schedule container-fluid mb-5 p-5 d-flex justify-content-center">
    <div class="container row align-items-center">
        <div class="col-lg-4 d-md-flex justify-content-center col-sm-12">
            <img src="{{ asset('images/background3.jpg') }}" class="img-fluid" alt="Schedule Image" />
        </div>
